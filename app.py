...
# ปรับ CSS ใหม่: ลบส่วนที่บังคับสีหัวข้อออกเพื่อให้ระบบเลือกสีขาวให้เองใน Dark mode
st.markdown("""
    <style>
    /* บังคับเฉพาะ Metric ให้เป็นสีดำบนพื้นขาวเพื่อให้ดูง่ายเหมือนเดิม */
    ...
    if btn_calc:
        ...
        try:
            ...
            if res_risk > 70:
                ...
                st.markdown("* รักษาสุขภาพต่อไป\n* ออกกำลังกายสม่ำเสมอ")

            # กราฟ
            fig, ax = plt.subplots(figsize=(10, 3.5))
            # ปรับสีกราฟให้เข้ากับ Dark mode
...
with exp:
    ...
    # ใช้ st.write ธรรมดาแทนสีดำ เพื่อให้มันเปลี่ยนเป็นสีขาวอัตโนมัติใน Dark Mode
